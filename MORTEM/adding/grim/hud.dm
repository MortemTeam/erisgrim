/datum/hud/human
	...
	//corner buttons
		...
		"look up"            = list("type" = /obj/screen/look_up,           "loc" = "EAST,BOTTOM+1:15",   "minloc" = "RIGHT-1,2:13", "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back17-1"),
		"throw"              = list("type" = /obj/screen/HUDthrow,          "loc" = "EAST+1,BOTTOM+1:16", "minloc" = "RIGHT,2:13",   "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back17-1"),
		"pull"               = list("type" = /obj/screen/pull,              "loc" = "EAST-1,BOTTOM+1:16", "minloc" = "RIGHT-2,2:13", "hideflag" = TOGGLE_BOTTOM_FLAG, "background" = "back17-1"),
